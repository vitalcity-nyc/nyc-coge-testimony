...
<header class="hero"><div class="wrap">
  ...
  <p class="dek" style="font-size:16px;color:var(--vc-charcoal);">Coverage now spans all five first-round borough hearings (Manhattan, the Bronx, Brooklyn, Queens and Staten Island) &mdash; the first round is complete. A written-comment period and further rounds run into mid-July 2026, and this tool will be updated as that testimony comes in. COGE's proposals are due to reach voters on the November 2026 ballot.</p>
